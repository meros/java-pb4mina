...
class ProtoBufEncoderTest {
    ...
    void testEncodeNonMessageThrows() {
        ...
        assertThrows(InvalidObjectException.class, () -> 
            encoder.encode(mockSession, invalidObject, mockOutput)
        );
    }
    ...
    void testEncodeNullObjectThrows() {
        assertThrows(Exception.class, () -> 
            encoder.encode(mockSession, null, mockOutput)
        );
    }

    /**
     * Creates a simple test protobuf message for testing.
     * Uses a dynamically created message with some fields.
     */
    private Message createTestMessage() {
        // Create a simple message using the Any type or a custom builder
        return com.google.protobuf.Any.pack(
            com.google.protobuf.StringValue.of("test message content")
        );
    }
}
